...
public class Main {
    ...
    @EJB
    private static IAtivarAulaServiceRemote ativaAulaHandler;
    private static ICriarAulaServiceRemote criarAulaHandler;
    ...
    public static void main(String[] args) {
    	presentation.fx.Startup.startGUI(ativaAulaHandler,criarAulaHandler);
